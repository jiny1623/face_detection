...
if __name__ == '__main__':
    ...
    with open('/content/drive/MyDrive/rippleai/input.json') as f:
    ...
    # img_paths = list_files_in_directory('./test')
    for jpg_file in tqdm(jpg_files):
        ...
        for _ in range(1):
            ...
            bboxes, kpss = detector.detect(img, 0.01)
            tb = datetime.datetime.now()
            # print('all cost:', (tb-ta).total_seconds()*1000)
        # print(jpg_file, bboxes.shape)
        # if kpss is not None:
            # print(kpss.shape)


        new_root = '/content/drive/MyDrive/rippleai/submission/scrfd_34g_0.01/images/'
