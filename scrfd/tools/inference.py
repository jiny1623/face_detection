...
def parse_args():
    parser = argparse.ArgumentParser(description='Inference SCRFD')
...
def main():
    ...
    detector = SCRFD(model_file=args.onnx_path)
    detector.prepare(-1)
    ...
    for jpg_file in tqdm(jpg_files):
        ...
        for _ in range(1):
            ...
            bboxes, kpss = detector.detect(img, args.thr)
